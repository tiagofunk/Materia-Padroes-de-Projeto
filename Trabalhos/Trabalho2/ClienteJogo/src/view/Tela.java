...
import controller.ObservadorControle;
...
//        setTitle( porta + "" );
    ...
    private void initComponents() {
        ...
        botaoDesfazerClique = new javax.swing.JButton();
        labelPecasAmarelas = new javax.swing.JLabel();
        labelPecasAzuis = new javax.swing.JLabel();
        ...
        botaoDesfazerClique.setText("Desfazer Clique");
        botaoDesfazerClique.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                botaoDesfazerCliqueActionPerformed(evt);
            }
        });

        labelPecasAmarelas.setText("Peças amarelas:     ");

        labelPecasAzuis.setText("Peças azuis:            ");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(botaoDesfazerClique)
                    .addComponent(labelPecasAmarelas)
                    .addComponent(labelPecasAzuis))
    ...
    private void botaoDesfazerCliqueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoDesfazerCliqueActionPerformed
        controle.desfazerClique();
    }//GEN-LAST:event_botaoDesfazerCliqueActionPerformed

    public static void main(String[] args) {
        Tela t = new Tela( new Controle() );
        t.setVisible( true );
        t.setLocationRelativeTo( null );
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton botaoDesfazerClique;
    ...
    private javax.swing.JLabel labelPecasAmarelas;
    private javax.swing.JLabel labelPecasAzuis;
    ...
    public void permitirJogada(boolean permitir) {
        for( int i = 0; i < Constantes.ALTURA_TABULEIRO; i ++ ){
            for( int j = 0; j < Constantes.LARGURA_TABULEIRO; j++ ){
                matrizLabels[ i ][ j ].setEnabled( permitir );
            }
        }
    }
    ...
    public void informarCasaClicada(int i, int j) {
        matrizLabels[ i ][ j ].setBorder(BorderFactory.createLineBorder(Color.red, 2));
    }
    ...
    public void limparEnfase() {
        for( int i = 0; i < Constantes.ALTURA_TABULEIRO; i++ ){
            for(int j = 0; j < Constantes.LARGURA_TABULEIRO; j++){
                matrizLabels[i][j].setBorder(null);
            }
        }
    }
    ...
    public void informarNumeroPecas(int pecasAmarelas, int pecasAzuis) {
        labelPecasAmarelas.setText( "Peças amarelas: " + pecasAmarelas );
        labelPecasAzuis.setText( "Peças Azuis: " + pecasAzuis );
    }
}
